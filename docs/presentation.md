...
- Sound starts muted on every page load. The visible sound toggle enables local Web Audio; unavailable audio is harmless, and hidden tabs do not start new sounds. Background animation has a separate persisted toggle.
